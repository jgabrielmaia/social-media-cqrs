...
public class LikePostController : ControllerBase
{
    ...
    public async Task<ActionResult> LikePostAsync(Guid id)
    {
        ...
        {
            _logger.Log(LogLevel.Warning, ex, "Client set a bad request");
        ...
        {
            _logger.Log(LogLevel.Warning, ex, "Could not retrieve aggregate, client passed an incorrect post ID target");
